...
function HolographicBlog() {
  ...
  useEffect(() => {
    ...
    try {
      ...
      console.log('[VIB3CODE] ✅ WebGL Manager initialized successfully');
    } catch (error) {
      console.error('[VIB3CODE] ❌ WebGL Manager initialization failed:', error);
    }
    ...
    return () => {
      ...
      try {
        ...
        console.error('[VIB3CODE] ❌ WebGL cleanup error:', error);
      }
    };
  }, []);
